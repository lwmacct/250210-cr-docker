...
RUN set -eux; \
    ...
    apk add --no-cache \
        busybox-extras openssh-server supervisor tini bash jq bc curl wget rsync vim sudo tzdata socat iproute2 tmux \
...
ghcr.io/lwmacct/250210-cr-docker:27.5.1-dind-2502100
